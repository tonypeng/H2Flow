...
struct b2BodyDef
{
	...
	b2BodyDef()
	{
		...
		inertiaScale = 1.0f;
		isGravitated = true;
		triggersBodyDeletionUponImpact = false;
	}
	...
	bool triggersBodyDeletionUponImpact;
...
inline bool b2Body::TriggersRemoval() const
{
	return (m_flags & e_triggerRemFlag) == e_triggerRemFlag;
}
